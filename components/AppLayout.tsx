  ...
  return (
    <div className={"App h-full " + (atTop ? "scroll-top" : "scroll-not-top")}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle farthest-side at center , rgba(0, 0, 0, .3), rgba(0, 0, 0, .5))",
...
function NavBar({
  ...
  return (
    <nav
      className={`Navbar p-4 sticky top-0 flex flex-row gap-3 items-start w-full self-center max-w-[536px]`}
      style={{
        // transform: `translateY(${(1-topLerp) * window.innerHeight}px)`
        zIndex: 100,
      }}
    >
      <p className="text-xl text-red-950 font-bold mr-auto mb-1 translate-y-[2px]" style={{
